...
var _idx=0,
	...
	history=[],
	baseThemeColors=['transparent','ffffff','000000','eeece1','1f497d','4f81bd','c0504d','9bbb59','8064a2','4bacc6','f79646'],
		...
		this._palette
			.on('click', sel, function(evt){
				if(that._enabled)
				{
					...
					if( $(this).attr('style').replace('background-color:#',"") == "transparent" )
						that._setValue("transparent");
					else
						that._setValue(c);
				}
			})
